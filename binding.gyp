  ...
  "targets": [
    {
      ...
      "sources": [
        "src-cpp/main.cc",
        "src-cpp/utils.cc",
        "src-cpp/metrosquare/calculate_qtfisher.cpp",
        "src-cpp/metrosquare/calculate_qtfisher_data.cpp",
        "src-cpp/metrosquare/calculate_qtfisher_initialize.cpp",
        "src-cpp/metrosquare/calculate_qtfisher_terminate.cpp",
        "src-cpp/metrosquare/calculate_qtsquare.cpp",
